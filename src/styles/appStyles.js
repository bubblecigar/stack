...
export const styles = StyleSheet.create({
  ...
  addCardSystemExplanation: {
    position: 'absolute',
    left: 34,
    right: 34,
    top: 54,
  },
  addCardSystemExplanationTitle: {
    color: '#94A3B8',
    fontFamily: 'Kalam_400Regular',
    fontSize: 20,
    fontWeight: '400',
  ...
  addCardMathKeyboardKeyRow: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    alignItems: 'flex-start',
    gap: 10,
  },
  addCardMathKeyboardKey: {
    width: 42,
    height: 34,
    borderRadius: 7,
    alignItems: 'center',
  ...
  addCardMathKeyboardAddKey: {
    borderStyle: 'dashed',
  },
  addCardMathKeyboardAddKeyText: {
    color: '#94A3B8',
    fontSize: 22,
    fontWeight: '400',
    lineHeight: 26,
  ...
  addCardCalendarDateSquareBlank: {
    opacity: 0.34,
  },
  addCardCalendarDateSquareToday: {
    borderColor: '#CBD5E1',
